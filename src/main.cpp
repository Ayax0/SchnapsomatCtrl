...
RecipeButton Button6(GPIO_NUM_12, GPIO_NUM_37, GPIO_NUM_38);
...
void setup() {
  ...
  uint8_t Wasser_einmal[INGREDIENCE_AMOUNT] = {1, 0, 0, 0, 0, 0, 0, 0};
  ...
  Button6.setIngredients(Wasser_einmal, INGREDIENCE_AMOUNT);
  ...
  Schnapsomat_Master.registerButton(5, &Button6);  //Wasser 
}
